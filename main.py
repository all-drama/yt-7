...
def video(url):
    ...
    if 'selected_stream' not in st.session_state:
        st.session_state.selected_stream = st.selectbox("Select Video Resolution", resolutions)
    else:
        st.session_state.selected_stream = st.selectbox("Select Video Resolution", resolutions, index=resolutions.index(st.session_state.selected_stream))

    # Find the selected stream based on the resolution string
    selected_stream = resolution_dict.get(st.session_state.selected_stream)
